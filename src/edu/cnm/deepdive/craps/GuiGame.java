...
public class GuiGame
  ...
  private final String WINS_FORMAT = "Wins = %d";
  private final String LOSSES_FORMAT ="Losses = %d";
  private final String POINT_FORMAT ="Point = %d";
  private final String ROLL_FORMAT = "Roll = %d";
	...
	synchronized (this) {
		for (int i = 0; i < 10; i++) {
			SwingUtilities.invokeLater(new Runnable(){
				...
				@Override
				public void run() {
					roll1.setIcon(dieFaces[rng.nextInt(2)]);
					roll2.setIcon(dieFaces[rng.nextInt(2)]);
					}
				});
			try {
				wait(60);
